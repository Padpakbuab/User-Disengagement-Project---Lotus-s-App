...
| **Coin Redemption Velocity** | Loyalty & Rewards | $\frac{\text{redeem\_coins\_confirm}_{30d}}{\text{enable\_use\_lotuss\_point}_{30d} + \epsilon}$ | `redeem_coins_confirm`, `enable_use_lotuss_point` | A declining ratio signals the user is no longer burning points/coins despite having points enabled. |
